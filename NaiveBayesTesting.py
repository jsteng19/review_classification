...
def main():
    ...
    #
    # t = time.perf_counter()
    # testing_accuracy = test(sys.argv[2], p_positive, p_negative, vocabulary, pair_vocabulary)
    ...
    for alpha in range(1, 10):
        p_positive, p_negative, vocabulary, pair_vocabulary = train(sys.argv[1], alpha / 10)
        testing_accuracy = test(sys.argv[2], p_positive, p_negative, vocabulary, pair_vocabulary)
        print(str(round(testing_accuracy, 3)) + " (testing)")
